...
<div class="container">
    <div class="row">
        <form class="col s12" action="{{ url('confirm/order')}}" method="POST">
            ...
            <div class="row">
                <div class="input-field col s6">
                    <input id="adress_1" type="text" name="address_1"
                        value="@if(isset($address->address_line_1)) {{$address->address_line_1}} @endif"
                        class="validate">
                    <label for="adress_1">Address Line 1</label>
                </div>
                <div class="input-field col s6">
                    <input id="adress_2" type="text" name="address_2"
                        value="@if(isset($address->address_line_2)) {{$address->address_line_2}} @endif"
                        class="validate">
